...
from Software.src.other.firebase.firestore import userPoints, endGame

from Software.src.display.quiz.choice1 import displayChoice1
from Software.src.display.quiz.choice2 import displayChoice2
from Software.src.display.quiz.click1 import displayClick1
from Software.src.display.quiz.DragAndDrop1 import displayDragAndDrop1
from Software.src.display.quiz.DragAndDrop2 import displayDragAndDrop2
from Software.src.display.quiz.DragAndDrop3 import displayDragAndDrop3
from Software.src.display.quiz.audio1 import displayAudio
from Software.src.display.scoreDuo import displayScoreDuo
...
class duo:
    """
        Classe qui permet de gérer le déroulement de la partie à deux (Duo)
    """
    ...
    def play(self):
        ...
        if self.currentQuestionIndex < len(self.randomList):
            ...
            displayScoreDuo(self.master, len(self.randomList), style=self.user + 1, user=self.user, token=self.token)
