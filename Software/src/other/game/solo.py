...
from Software.other.json.JsonFile import readJsonFileSchema

from Software.display.quiz.choice1 import displayChoice1
from Software.display.quiz.choice2 import displayChoice2
from Software.display.quiz.click1 import displayClick1
from Software.display.quiz.DragAndDrop1 import displayDragAndDrop1
from Software.display.quiz.DragAndDrop2 import displayDragAndDrop2
from Software.src.display.quiz.DragAndDrop3 import displayDragAndDrop3
from Software.display.quiz.audio1 import displayAudio
from Software.display.score import displayScore
...
class solo:
    """
        Classe qui permet de gérer le déroulement de la partie en solo (Solo)
    """
