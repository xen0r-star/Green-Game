...
class displayAudio(Frame):
    """
        Interface du quiz - Partie 1 : Jeu pour retrouver le sens du son
    """
    ...
    "Mettre à jour la barre de progression d'écoute du son"
    ...
    "Créer l'image de la barre de progression d'écoute du son"
