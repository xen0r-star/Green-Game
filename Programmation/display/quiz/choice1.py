...
class displayChoice1(Frame):
    def __init__(self, master, style=1, playerPoint=[0, 0], time=60, currentQuestion = 0, maxQuestion=20):
        ...
        self.textQuestion = "Quel est le principal avantage des voitures électriques par rapport aux voitures à essence ?"
        self.textResponse = ["Elles sont moins chères à l'achat.", 
                             "Elles émettent moins de CO2.", 
                             "Elles nécessitent moins d'entretien.", 
                             "Elles ont une plus grande autonomie."]
