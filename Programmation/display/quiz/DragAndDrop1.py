...
class displayDragAndDrop1(Frame):
    def __init__(self, master, style=1, playerPoint=[0, 0], time=60, currentQuestion = 0, maxQuestion=20):
        ...
        self.textQuestion = "Replace les éléments dans l'ordre chronologique."
        self.textResponse = ["Les matériaux triés sont nettoyés.", 
                             "Les objets sont collectés.", 
                             "Les matériaux recyclés deviennent de nouveaux produits.", 
                             "Les objets sont déposés dans les bacs.", 
                             "Les matériaux sont triés par type."]
        self.correctResponse = [4, 2, 5, 1, 3]
